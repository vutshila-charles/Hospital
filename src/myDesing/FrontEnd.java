...
public class FrontEnd {
	...
	private void initialize() {
		...
		UserLogincomboBox.setModel(new DefaultComboBoxModel(new String[] {"Accounts", "Admin", "Doctor", "Patient", "Pharmacist", "Manager", "CreateAccount"}));
		...
		UserLogincomboBox.addActionListener(new ActionListener() 
		{
			public void actionPerformed(ActionEvent arg0) 
			{
				...
				if(UserLogincomboBox.getSelectedItem().equals("Pharmacist"))
				{
					LogginPharmacy myhospital = new LogginPharmacy();
					myhospital.frame.setVisible(true);
					frame.dispose();
				}
				if(UserLogincomboBox.getSelectedItem().equals("Manager"))
				{
					ManagerLogin myhospital = new ManagerLogin();
					myhospital.frame.setVisible(true);
					frame.dispose();
				}
				
				if(UserLogincomboBox.getSelectedItem().equals("Doctor"))
				{
					DoctorLogin myhospital = new DoctorLogin();
					myhospital.frame.setVisible(true);
					frame.dispose();
				}
