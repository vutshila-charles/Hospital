...
try {
				...
				{
					JOptionPane.showMessageDialog(null, " details have been daleted");
				}
			}
		});
		panel.add(button_2);
		...
		label_15.setBounds(542, 220, 118, 14);
		...
		textField_10.setBounds(688, 223, 266, 20);
		...
		textField_15.setBounds(162, 61, 329, 20);
